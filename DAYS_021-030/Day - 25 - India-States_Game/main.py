...
my_screen.title("Indian States & Union Territories Game")
my_screen.setup(height=750, width=650)
my_screen.bgpic("Map Of India.png")
...
while len(guessed_states) < 37:
    ...
    answer_state = my_screen.textinput(title=f"{len(guessed_states)}/36 States Correct",
...
text.goto(-20, -335)
text.write("Click to close", align="center", font=BIGTEXT)
my_screen.exitonclick()


# Puducherry[(-55,-192),(-53,-211),(-10,-106),(-131,-189)]
